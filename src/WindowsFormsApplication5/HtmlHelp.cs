...
namespace WindowsFormsApplication5
{
    public class HtmlHelp
    {
        ...
        public static string sends(string url, string post, string method, string ghq)
        {
            HttpWebRequest myHttpWebRequest;
            byte[] oneData = { };
            ...
            myHttpWebRequest.ContentType = "application/x-www-form-urlencoded; charset=UTF-8";
            myHttpWebRequest.ContentLength = oneData.Length;
            myHttpWebRequest.Referer = "http://www.bjguahao.gov.cn/comm/TG/guahao.php?" + ghq;
            Stream newMyStream = myHttpWebRequest.GetRequestStream();
            newMyStream.Write(oneData, 0, oneData.Length);
        ...
        public static Image LoadCodeImg()
        {
            try
            {
                string oneUrl = "http://www.bjguahao.gov.cn/comm/code.php?id=";
                ...
                myHttpWebRequest.Method = "GET";
                myHttpWebRequest.ContentType = "application/x-www-form-urlencoded";
                myHttpWebRequest.Referer = "http://www.bjguahao.gov.cn/comm/index.html";
